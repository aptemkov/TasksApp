...
val testList = mutableListOf(
    ...
    Task(id = "2", description = "Утром пресс качат, бегит, анжуманя, турник", priority = Priority.LOW, deadline = 123121L, isDone = true, createDate = 0L, editDate = 0L),
    ...
    Task(id = "4", description = "Сходить в магазин за покупками", priority = Priority.DEFAULT, deadline = 101200214L, isDone = true, createDate = 0L, editDate = 0L),

    Task(id = "5", description = "Сделать задачу ниже", priority = Priority.HIGH, deadline = 11920471L, isDone = false, createDate = 0L, editDate = 0L),
    Task(id = "6", description = "Сделать задачу выше", priority = Priority.HIGH, deadline = 13457821L, isDone = true, createDate = 0L, editDate = 0L),
    ...
    Task(id = "10", description = "Задача номер 10", priority = Priority.LOW, deadline = 10003423, isDone = false, createDate = 0L, editDate = 0L),
    Task(id = "11", description = "Задача номер 11", priority = Priority.LOW, deadline = 12003423, isDone = false, createDate = 0L, editDate = 0L),
    Task(id = "12", description = "Задача номер 12", priority = Priority.LOW, deadline = 130503423, isDone = false, createDate = 0L, editDate = 0L),
    Task(id = "13", description = "Задача номер 13", priority = Priority.LOW, deadline = 130103423, isDone = false, createDate = 0L, editDate = 0L),
    Task(id = "14", description = "Задача номер 14", priority = Priority.HIGH, deadline = 131333423, isDone = true, createDate = 0L, editDate = 0L),
    Task(id = "15", description = "Задача номер 15", priority = Priority.LOW, deadline = 132103423, isDone = false, createDate = 0L, editDate = 0L),
)