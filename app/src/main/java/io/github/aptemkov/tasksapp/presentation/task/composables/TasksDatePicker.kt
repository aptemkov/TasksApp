...
fun TasksDatePicker(
    ...
    Row(
        ...
        val switchContentDescription = stringResource(R.string.deadline_status)
        val switchStateDescription =  stringResource(
            if (hasDeadLine) R.string.deadline_status_added else R.string.deadline_status_not_added
        )
        ...
        Switch(
            modifier = Modifier
                .semantics {
                    role = Role.Switch
                    contentDescription = switchStateDescription
                    stateDescription = switchContentDescription
                },
